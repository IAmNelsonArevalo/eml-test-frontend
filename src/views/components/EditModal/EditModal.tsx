...
const EditModal: React.FC<IEditModal> = ({
    ...
    const {useEditModal} = useComponents();
    const {inputs, handleEditUser, handleSubmit, control, reset} = useEditModal();
    ...
    React.useEffect(() => {
        ...
        reset({
            name: data_edit.name,
            last_name: data_edit.last_name,
            phone: data_edit.phone,
            document: data_edit.document,
            document_type: data_edit.document_type,
